...
def checkforwin():
    if(button1['text'] == "X" and button2["text"] == "X" and button3["text"] == "X" or
       ...
       button3['text'] == "X" and button6["text"] == "X" and button9["text"] == "X"):
        disableButton()
        tkinter.messagebox.showinfo("Tic tae toe", playerA)

    elif(flag == 8):
        tkinter.messagebox.showinfo("Tic tae toe", "It is  a lie")
    
    elif(button1['text'] == "O" and button2["text"] == "O" and button3["text"] == "O" or
         button4['text'] == "O" and button5["text"] == "O" and button6["text"] == "O" or
         button7['text'] == "O" and button8["text"] == "O" and button9["text"] == "O" or
         button1['text'] == "O" and button5["tex0t"] == "O" and button9["text"] == "O" or
         button3['text'] == "O" and button5["text"] == "O" and button7["text"] == "O" or
         button1['text'] == "O" and button4["text"] == "O" and button7["text"] == "O" or
         button2['text'] == "O" and button5["text"] == "O" and button8["text"] == "O" or
         button3['text'] == "O" and button6["text"] == "O" and button9["text"] == "O"):
        disableButton()
        tkinter.messagebox.showinfo("Tic tae toe", playerB)
    elif (flag==9):
        tkinter.messagebox.showinfo("Tic tae toe", "Its a tie!!")
...
resetButton = Button(tk, text="Reset", font="Times 20 bold",
                     bg="white", fg="black", height=2, width=5, command=lambda: reset())
